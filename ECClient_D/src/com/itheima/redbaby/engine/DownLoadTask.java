		...
		try {
			...
			while (threadCount != countSucess && flag && threadCount != stop) {
				...
				case DownMessage.MSG_SUCCESS:
					countSucess++;
					Logger.d(TAG, "线程Id=" + msg.threadid + "已完成下载");
					break;
			...
			Logger.d(TAG, "耗时" + (System.currentTimeMillis() - starttime));
